...
# Canonical agent types: agent (standard), pipeline (graph-based), predict (no memory)
# Legacy types (react, openai, xml) are normalized to 'agent' in client.py
agent_types = ["agent", "pipeline", "predict"]

...
from .mixedAgentRenderes import conversation_to_messages, format_to_langmessages, convert_message_to_json
...
class AutoGenAssistantRunnable(RunnableSerializable):
    client: Optional[Any]
    ...
    def create_assistant(
        ...
        return cls(client=client, assistant=assistant, chat_history=[])

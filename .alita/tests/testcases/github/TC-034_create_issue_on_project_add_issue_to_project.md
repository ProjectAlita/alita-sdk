# create_issue_on_project: add issue to project
...
Create an issue in a project via GraphQL and validate success message pattern.
...
| **Tool** | `create_issue_on_project` | Exact Python tool name |
...
- Valid GraphQL access via token
- Target project exists or use test data generation

## Test Steps & Expectations

### Step 1: Execute the Tool

Run `create_issue_on_project` with the following arguments 
...
Validate message starts with `The issue with number` and may include fields update summary.
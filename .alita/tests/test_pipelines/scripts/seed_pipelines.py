...
def load_from_env(var_name: str) -> str | None:
    ...
    env_paths = [
        ...
        Path(__file__).parent.parent / ".env",  # test_pipelines/.env (generated by setup.py)
        Path(__file__).parent.parent.parent.parent.parent / ".env",  # alita-sdk/.env
        Path(__file__).parent.parent.parent.parent.parent.parent / ".env",  # elitea/.env (root)
    ]

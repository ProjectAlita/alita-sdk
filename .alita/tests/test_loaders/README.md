...
cat alita_sdk/cli/loader_test_runner.py  # Test runner
```
...
```bash
# Set breakpoint in loader_test_runner.py or loader source
python -m pdb run_tests.py run AlitaCSVLoader csv_simple -c 1
```

**Key files to debug**:
- `alita_sdk/cli/loader_test_runner.py` - Test execution logic
- `alita_sdk/cli/loader_test_utils.py` - Comparison logic
...
| Comparison logic | `alita_sdk/cli/loader_test_utils.py` |
| Test runner logic | `alita_sdk/cli/loader_test_runner.py` |
...
| `alita_sdk/cli/loader_test_runner.py` | Test execution engine |
| `alita_sdk/cli/loader_test_utils.py` | Document comparison logic |
...
└─────────────────┬──────────────────────────────────────────┘
                  │
┌─────────────────▼──────────────────────────────────────────┐
│ 2. Config Resolution (loader_test_runner.py)              │

...
```bash
# Run all tests for AlitaMarkdownLoader
python .alita/tests/test_loaders/run_tests.py run AlitaMarkdownLoader

# Run specific input file
python .alita/tests/test_loaders/run_tests.py run AlitaMarkdownLoader markdown_large

# Run single config (e.g., config 1 for markdown_large)
python .alita/tests/test_loaders/run_tests.py run AlitaMarkdownLoader markdown_large -c 1

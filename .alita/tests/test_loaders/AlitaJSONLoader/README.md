...
```bash
# Run all tests for AlitaJSONLoader
python .alita/tests/test_loaders/run_tests.py run AlitaJSONLoader

# Run specific input file
python .alita/tests/test_loaders/run_tests.py run AlitaJSONLoader json_large

# Run single config (e.g., config 1 for json_large)
python .alita/tests/test_loaders/run_tests.py run AlitaJSONLoader json_large -c 1

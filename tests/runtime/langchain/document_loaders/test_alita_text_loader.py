"""
Pytest tests for AlitaTextLoader.

Test cases are auto-discovered from:
  tests/runtime/langchain/document_loaders/test_data/AlitaTextLoader/input/*.json
...
Run:
  ...
  pytest tests/runtime/langchain/document_loaders/test_alita_text_loader.py -v -k "text_simple"

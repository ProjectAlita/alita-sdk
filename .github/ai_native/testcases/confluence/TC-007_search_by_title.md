...
| **Query** | `test` | Search query text for title |
...
- At least one page exists with `test` in the title

## Test Steps & Expectations

### Step 1: Execute the Tool

Execute the `search_by_title` tool with query parameter set to `test`.
